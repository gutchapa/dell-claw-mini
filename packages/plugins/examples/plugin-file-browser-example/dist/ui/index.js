...
// ../../../../node_modules/.pnpm/@codemirror+view@6.41.0/node_modules/@codemirror/view/dist/index.js
...
var PLUGIN_KEY = "paperclip-file-browser-example";
var FILES_TAB_SLOT_ID = "files-tab";
var editorBaseTheme = {
  "&": {
    height: "100%"
  },
...
var editorLightTheme = EditorView.theme({
  ...editorBaseTheme,
  "&": {
    ...editorBaseTheme["&"],
...
var editorDarkHighlightStyle = HighlightStyle.define([
...
var editorLightHighlightStyle = HighlightStyle.define([
...
var PathLikePattern = /[\\/]/;
var WindowsDrivePathPattern = /^[A-Za-z]:[\\/]/;
var UuidPattern = /^[0-9a-f]{8}-[0-9a-f]{4}-[1-5][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/i;
function isLikelyPath(pathValue) {
...
function useAvailableHeight(ref, options) {
...
function FileTreeNode({
    ...
    return /* @__PURE__ */ jsxs("li", { children: [
      /* @__PURE__ */ jsxs(
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ jsx2("span", { className: "w-3 text-xs text-muted-foreground", children: isExpanded ? "\u25BE" : "\u25B8" }),
            /* @__PURE__ */ jsx2("span", { className: "truncate font-medium", children: entry.name })
          ]
        }
      ),
  ...
  return /* @__PURE__ */ jsx2("li", { children: /* @__PURE__ */ jsx2(
    "button",
    {
      ...
      children: /* @__PURE__ */ jsx2("span", { className: "truncate", children: entry.name })
    }
  ) });
}
function ExpandedDirectoryChildren({
  ...
  const { data: childData } = usePluginData("fileList", {
    companyId,
    projectId,
    workspaceId,
    directoryPath
  ...
  return /* @__PURE__ */ jsx2("ul", { className: "space-y-0.5", children: children.map((child) => /* @__PURE__ */ jsx2(
    FileTreeNode,
    {
      entry: child,
      companyId,
...
function FilesLink({ context }) {
  const { data: config2, loading: configLoading } = usePluginData("plugin-config", {});
  const showFilesInSidebar = config2?.showFilesInSidebar ?? false;
  ...
  return /* @__PURE__ */ jsx2(
    "a",
    {
      ...
      className: `block px-3 py-1 text-[12px] truncate transition-colors ${isActive ? "bg-accent text-foreground font-medium" : "text-muted-foreground hover:text-foreground hover:bg-accent/50"}`,
      children: "Files"
    }
  );
}
function FilesTab({ context }) {
  ...
  const { data: fileListData, loading: fileListLoading } = usePluginData(
    "fileList",
    fileListParams
  );
  ...
  const fileContentParams = useMemo(
    () => selectedPath && selectedWorkspace ? { projectId, companyId, workspaceId: selectedWorkspace.id, filePath: selectedPath } : null,
  ...
  const [mobileView, setMobileView] = useState("browser");
  useEffect(() => {
    if (!editorRef.current) return;
    const content2 = fileContentData?.content ?? "";
    loadedContentRef.current = content2;
    setIsDirty(false);
    setSaveMessage(null);
    setSaveError(null);
    if (viewRef.current) {
  ...
  async function handleSave() {
    ...
    const content2 = viewRef.current.state.doc.toString();
    setIsSaving(true);
    setSaveError(null);
    setSaveMessage(null);
    try {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
    /* @__PURE__ */ jsxs("div", { className: "rounded-lg border border-border bg-card p-4", children: [
      /* @__PURE__ */ jsx2("label", { className: "text-sm font-medium text-muted-foreground", children: "Workspace" }),
      /* @__PURE__ */ jsx2(
        "select",
        {
          ...
          children: workspaces.map((w) => {
            ...
            return /* @__PURE__ */ jsx2("option", { value: w.id, label, title: label, children: label }, `${w.id}:${label}`);
          })
        },
        workspaceSelectKey
      )
    ...
    /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        style: {
          ...
          gap: "1rem",
          gridTemplateColumns: isMobile ? void 0 : "320px minmax(0, 1fr)",
          height: availableHeight ? `${availableHeight}px` : void 0,
        ...
        children: [
          /* @__PURE__ */ jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsx2("div", { className: "border-b border-border px-3 py-2 text-xs font-medium uppercase tracking-[0.12em] text-muted-foreground", children: "File Tree" }),
                /* @__PURE__ */ jsx2("div", { className: "min-h-0 flex-1 overflow-auto p-2", children: selectedWorkspace ? fileListLoading ? /* @__PURE__ */ jsx2("p", { className: "px-2 py-3 text-sm text-muted-foreground", children: "Loading files..." }) : entries.length > 0 ? /* @__PURE__ */ jsx2("ul", { className: "space-y-0.5", children: entries.map((entry) => /* @__PURE__ */ jsx2(
                  FileTreeNode,
                  {
                    entry,
                    companyId,
                  ...
                  entry.path
                )) }) : /* @__PURE__ */ jsx2("p", { className: "px-2 py-3 text-sm text-muted-foreground", children: "No files found in this workspace." }) : /* @__PURE__ */ jsx2("p", { className: "px-2 py-3 text-sm text-muted-foreground", children: "Select a workspace to browse files." }) })
              ]
            }
          ),
          /* @__PURE__ */ jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxs("div", { className: "sticky top-0 z-10 flex items-center justify-between gap-3 border-b border-border bg-card px-4 py-2", children: [
                  /* @__PURE__ */ jsxs("div", { className: "min-w-0", children: [
                    ...
                    /* @__PURE__ */ jsx2("div", { className: "text-xs font-medium uppercase tracking-[0.12em] text-muted-foreground", children: "Editor" }),
                    /* @__PURE__ */ jsx2("div", { className: "truncate text-sm text-foreground", children: selectedPath ?? "No file selected" })
                  ] }),
                ...
                isDirty || saveMessage || saveError ? /* @__PURE__ */ jsx2("div", { className: "border-b border-border px-4 py-2 text-xs", children: saveError ? /* @__PURE__ */ jsx2("span", { className: "text-destructive", children: saveError }) : saveMessage ? /* @__PURE__ */ jsx2("span", { className: "text-emerald-600", children: saveMessage }) : /* @__PURE__ */ jsx2("span", { className: "text-muted-foreground", children: "Unsaved changes" }) }) : null,
                selectedPath && fileContentData?.error && fileContentData.error !== "Missing file context" ? /* @__PURE__ */ jsx2("div", { className: "border-b border-border px-4 py-2 text-xs text-destructive", children: fileContentData.error }) : null,
                /* @__PURE__ */ jsx2("div", { ref: editorRef, className: "min-h-0 flex-1 overflow-auto overscroll-contain" })
              ]
            }
          )
        ]
...
function CommentFileLinks({ context }) {
  const { data: config2 } = usePluginData("plugin-config", {});
  const mode = config2?.commentAnnotationMode ?? "both";
  const { data } = usePluginData("comment-file-links", {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center gap-1.5", children: [
    /* @__PURE__ */ jsx2("span", { className: "text-[10px] font-medium uppercase tracking-wider text-muted-foreground", children: "Files:" }),
    data.links.map((link) => {
...
function CommentOpenFiles({ context }) {
  const { data: config2 } = usePluginData("plugin-config", {});
  const mode = config2?.commentAnnotationMode ?? "both";
  const { data } = usePluginData("comment-file-links", {
    commentId: context.entityId,
  ...
  return /* @__PURE__ */ jsxs("div", { children: [
    /* @__PURE__ */ jsx2("div", { className: "px-2 py-1 text-[10px] font-medium uppercase tracking-wider text-muted-foreground", children: "Files" }),
    data.links.map((link) => {
      const href = buildFileBrowserHref(prefix, projectId, link);
      ...
      return /* @__PURE__ */ jsx2(
        "a",
        {
          ...
          title: `Open ${link} in file browser`,
          children: /* @__PURE__ */ jsx2("span", { className: "truncate font-mono", children: fileName })
        },
        link
      );
    })
